...
<body>
	...
	<article>
		<div class="content">
			<div class="container">
				...
				<p id="listen">
					我听过<span id="num">0 </span>首歌
				</p>
				<div id="user_con">
					<div class="row" id="first">
						<div class="music_no_1 col-lg-2 col-md-2 col-sm-2 col-xs-2">编号</div>
						<div class="music_name_! col-lg-6 col-md-6 col-sm-10 col-xs-10"
							style="border-left: 1px solid #E1E1E1;">
							<span class="m_name_1">歌曲名</span>
						</div>
						<div class=" music_play_1 col-lg-2 col-md-2 hidden-sm hidden-xs"
							style="border-left: 1px solid #E1E1E1;">歌手</div>
						<div class="music_add_1 col-lg-2 col-md-2 hidden-sm hidden-xs"
					...
					<div id="cunge">
						<div class="row">
							...
							<div class="music_name col-lg-6 col-md-6 col-sm-10 col-xs-10">
								<a class="a1" href=""><i
									class="glyphicon glyphicon-play-circle" id="tp1_1" title="播放"></i></a>
								<a href=""><i class="glyphicon glyphicon-save" id="tp2_1"
									title="下载"></i></a> <a href="" class="m_name">River Flows In
									You</a>
							</div>
						...
						<div class="row">
							...
							<div class="music_name col-lg-6 col-md-6 col-sm-10 col-xs-10">
								<a class="a1" href=""><i
									class="glyphicon glyphicon-play-circle" id="tp1_2" title="播放"></i></a>
								<a href=""><i class="glyphicon glyphicon-save" id="tp2_2"
									title="下载"></i></a> <a href="" class="m_name">River Flows In
									You</a>
							</div>
							<div class="music_play col-lg-2 col-md-2 hidden-sm hidden-xs">Martin-Ermen</div>
	...
	<nav class="navbar navbar-default navbar-fixed-bottom bg">
		...
		<i><img class="play" id="play" onclick="myplay(this)"
			src="images/playbar_11.png"></i> <i><img class="fast" id="fast"
			src="images/playbar_05.png"></i> <i class="mask"><img
			class="mask1" src="images/fwq.jpg"></i>
		...
		<div class="suop">
			<i><img class="suo" src="images/playbar_49.png"></i> <i><img
				class="suo1" src="images/playbar_51.png"></i>
		</div>
		<i><img title="顺序播放" class="xh" id="xh"
			src="images/playbar_23.png"></i> <i><img title="随机播放"
			class="sj" id="sj" src="images/playbar_17.png"></i> <i><img
			class="sc" title="收藏" src="images/playbar_40.png"></i> <i><img
			class="muted" id="muted" onclick="Muted(this)"
			src="images/playbar_14.png"></i>
		<div id="volume">
		...
		<i><img class="meu" tabindex="0" hidefocus="true"
			src="images/playbar_48.png"></i>
		<div class="mymeu">
			<ul>
				<li class="meuli"><span class="span2">阿悄 - 死皮赖脸</span> <span
					class="span3">03:14</span></li>
				<li class="meuli"><span class="span2">夏婉安 - 一个人</span> <span
					class="span3">03:14</span></li>
				<li class="meuli"><span class="span2">威仔 - 不爱又何必纠缠</span> <span
					class="span3">03:14</span></li>
			</ul>
		</div>
		<p class="shuo">0</p>
