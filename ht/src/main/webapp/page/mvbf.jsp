                ...
                <div class="container">
                    <div class="row">
                        <ul class="nav navbar-nav navbar-left" id="topnav">
                            <li><a href="page/index.jsp"  class="col-lg-2 col-md-2 col-sm-3 col-xs-4">首页</a></li>
                            ...
                            <li><div class="mydiv hidden-md hidden-sm hidden-xs"></div><a href="page/mv.jsp"  class="col-lg-2 col-md-2  hidden-xs  hidden-sm hidden-xs">MV</a></li>
